  ...
  return (
    <div className="font-sans">
      ...
      <section className="py-16 px-6 bg-white">
        <h2 className="text-3xl font-semibold text-center mb-6">Tu Carrito</h2>
        {cart.length === 0 ? (
          ...
          <ul className="max-w-2xl mx-auto space-y-4">
            {cart.map((item, index) => (
              <li key={index} className="flex justify-between items-center border-b pb-2">
                <div>
                  ...
                  <span className="text-gray-600">${item.price} MXN</span>
                </div>
                <button
            ...
            <li className="flex justify-between font-semibold pt-4 border-t">
              <span>Total:</span>
              <span>${cart.reduce((total, item) => total + item.price, 0)} MXN</span>
            </li>
          </ul>
        )}
      </section>
